#
#  Example makefile to build a simple CC13xx executable using:
#      o a "closure" of a pre-configured TI-RTOS with MT wiring
#      o the CC13xx DriverLib, and
...
#   CC1352R1_LAUNCHXL CC1352 LaunchPad
VARIANT ?= CC1352R1_LAUNCHXL
PROGNAME ?= blink

# define CC13xx DriverLib libs and headers based on definitions above
SDK_LIBS = $(DRVLIB.cc13x2)/driverlib/bin/ccs/driverlib.lib

#define board-specific library path
BRD_LIBS = $(CLOSURE)/ti/runtime/wiring/cc13x2/variants/$(VARIANT)
BRD_DEFS = -DBOARD_$(VARIANT) -DDEVICE_FAMILY=cc13x2
...
ifeq ("true",$(ISINO))
  $(PROGNAME).cpp main.cpp: $(PROGNAME).ino 
	@echo making $@ ...
	$(INO2CPP) -E -o . $(SRCDIR) cc1300emt:$(VARIANT)
endif
